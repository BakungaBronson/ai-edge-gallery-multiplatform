...
import com.google.ai.edge.gallery.shared.resources.chat_you
import com.google.ai.edge.gallery.shared.resources.running
import com.google.ai.edge.gallery.shared.resources.warming_up
        ...
        is ChatMessageBenchmarkResult -> {
          ...
          val statusLabel =
            if (message.isWarmingUp()) {
              stringResource(Res.string.warming_up)
            } else if (message.isRunning()) {
              stringResource(Res.string.running)
            } else ""
...
private fun getMessageLayoutConfig(
  ...
  var userLabel = stringResource(Res.string.chat_you)
  var rightSideLabel = ""
