...
import com.google.ai.edge.gallery.platform.PlatformBitmap
import com.google.ai.edge.gallery.shared.resources.Res
import com.google.ai.edge.gallery.shared.resources.cd_user_image
import com.google.ai.edge.gallery.shared.resources.cd_user_image_in_group
...
fun MessageBodyImage(
  ...
  onImageClicked: (bitmaps: List<PlatformBitmap>, selectedBitmapIndex: Int) -> Unit,
  ...
  if (imageCount == 1) {
    ...
    Image(
      bitmap = imageBitMap,
      contentDescription = stringResource(Res.string.cd_user_image),
      modifier =
        ...
        Row(
          ...
          for (col in 0..<colCount) {
            ...
            Image(
              bitmap = imageBitMap,
              contentDescription =
                stringResource(Res.string.cd_user_image_in_group, imageIndex + 1, imageCount),
              modifier =
