...
private val SHAPES: List<DrawableResource> =
  listOf(
    Res.drawable.circle,
    Res.drawable.double_circle,
    Res.drawable.pantegon,
    Res.drawable.four_circle,
  )
...
@Composable
private fun getTaskIconBgShape(task: Task): androidx.compose.ui.graphics.painter.Painter {
