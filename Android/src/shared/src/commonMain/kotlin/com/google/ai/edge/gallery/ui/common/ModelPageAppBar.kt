...
import com.google.ai.edge.gallery.shared.resources.cd_model_settings_icon
import com.google.ai.edge.gallery.shared.resources.cd_navigate_back_icon
import com.google.ai.edge.gallery.shared.resources.cd_reset_session_icon
        ...
        if (showConfigButton) {
          ...
          IconButton(
            ...
            Icon(
              ...
              contentDescription = stringResource(Res.string.cd_model_settings_icon),
            ...
            IconButton(
              ...
              Box(
                ...
                Icon(
                  ...
                  contentDescription = stringResource(Res.string.cd_reset_session_icon),
                  tint = MaterialTheme.colorScheme.onSurface,
                  modifier = Modifier.size(20.dp),
                )
              }
