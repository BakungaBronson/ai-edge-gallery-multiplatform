...
import com.google.ai.edge.gallery.shared.resources.close
import com.google.ai.edge.gallery.shared.resources.tos_dialog_agree_and_continue_button_label
import com.google.ai.edge.gallery.shared.resources.tos_dialog_title_gemma
  ...
  Dialog(onDismissRequest = onCancel) {
    Card(shape = RoundedCornerShape(28.dp)) {
      Column(modifier = Modifier.padding(horizontal = 24.dp).padding(bottom = 24.dp)) {
        // Title.
        Text(
          stringResource(Res.string.tos_dialog_title_gemma),
        ...
        Row(
          ...
          Button(onClick = onTosAccepted) {
            Text(
              stringResource(
                if (viewingMode) Res.string.close
                else Res.string.tos_dialog_agree_and_continue_button_label
              )
            )
          }
        }
