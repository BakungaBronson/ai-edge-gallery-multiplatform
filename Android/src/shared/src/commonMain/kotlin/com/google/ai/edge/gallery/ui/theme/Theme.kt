...
@Composable
expect fun PlatformThemeEffect(useDarkTheme: Boolean)

@Composable
fun GalleryTheme(content: @Composable () -> Unit) {
  val themeOverride = ThemeSettings.themeOverride
  val darkTheme: Boolean =
    (isSystemInDarkTheme() || themeOverride.value == AppTheme.THEME_DARK) &&
      themeOverride.value != AppTheme.THEME_LIGHT

  PlatformThemeEffect(useDarkTheme = darkTheme)
