...
import com.google.ai.edge.gallery.shared.resources.tos_dialog_accept_and_continue_button_label
import com.google.ai.edge.gallery.shared.resources.tos_dialog_title_app
  ...
  Dialog(
    ...
    Card(shape = RoundedCornerShape(28.dp)) {
      Column(modifier = Modifier.padding(horizontal = 24.dp)) {
        // Title.
        Text(
          stringResource(Res.string.tos_dialog_title_app),
        ...
        Button(
          ...
          Text(
            stringResource(
              ...
              else Res.string.tos_dialog_accept_and_continue_button_label
            )
          )
        }
      }
